...
namespace API.SignalR
{
    public class MessageHub : Hub
    {
        ...
        IUsersRepository userRepository, IHubContext<PresenceHub> presenceHub, PresenceTracker tracker)
        {
            _tracker = tracker;
        ...
        {
            var group = await _messageRepository.GetMessageGroup(gruopName);
